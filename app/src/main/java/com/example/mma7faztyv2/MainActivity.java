...
//sending data to the records activity
    ...
    public void recyclerDummyEntry() {
        caller_ma7fazaDatabase.addbudget(new budgetData(1,"title1", new dateTime("6/6/2020","3:00"),new calcData(10,4,6,0)));
        caller_ma7fazaDatabase.addbudget(new budgetData(2,"title2",new dateTime("8/7/2020","3:00"),new calcData(10,4,6,0)));
        caller_ma7fazaDatabase.addbudget(new budgetData(3,"title3",dateTime.getCurrentDateTime(),             new calcData(10,4,6,0)));
        caller_ma7fazaDatabase.addbudget(new budgetData(4,"title4", new dateTime("9/7/2020","3:00"),new calcData(10,4,6,0)));
        caller_ma7fazaDatabase.addbudget(new budgetData(5,"title5", new dateTime("11/7/2020","3:00"),new calcData(10,4,6,0)));
        caller_ma7fazaDatabase.addbudget(new budgetData(6,"title6", new dateTime("6/8/2020","3:00"),new calcData(10,4,6,0)));
        caller_ma7fazaDatabase.addbudget(new budgetData(7,"title7", new dateTime("6/9/2020","3:00"),new calcData(10,4,6,0)));
        caller_ma7fazaDatabase.addbudget(new budgetData(8,"title8", new dateTime("6/11/2020","3:00"),new calcData(10,4,6,0)));
        caller_ma7fazaDatabase.addbudget(new budgetData(9,"title9", new dateTime("6/6/2021","3:00"),new calcData(10,4,6,0)));
